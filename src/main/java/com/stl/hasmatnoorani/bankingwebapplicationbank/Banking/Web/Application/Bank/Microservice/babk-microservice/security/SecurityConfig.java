...
import com.stl.hasmatnoorani.bankingwebapplicationbank.Banking.Web.Application.Bank.Microservice.jwt.JwtFilter;
...
public class SecurityConfig {
    ...
    public AuthenticationProvider auth() {
        ...
        provider.setUserDetailsService((UserDetailsService) bankManagerLoginDetailsService);
    ...
    SecurityFilterChain securityfilterchain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().cors().disable().authorizeHttpRequests()
                .requestMatchers("/api/v1/bank-manager/auth/add","/api/v1/bank-manager/auth/authenticate")
                .permitAll()
